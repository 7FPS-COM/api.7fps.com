const maintenanceHtml = `        <div>
<!doctype html>
<title>FORTNITE-TOOLS.COM Maintenance</title>
<link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,700" rel="stylesheet">
<style>
  html, body { padding: 0; margin: 0; width: 100%; height: 100%; }
  * {box-sizing: border-box;}
  body { text-align: center; padding: 0; background: #272727; color: #fff; font-family: Open Sans; }
...
<article>
    ...
    <div>
        ...
        <p>&mdash; The FORTNITE-TOOLS.COM Team</p>
    </div>
</article>
        </div>`
;
